...
csv_file_path = 'play_ransomware_data.csv'  # Update with your CSV file path
rows = []
...
for row in rows:
    description = row['Company Info']  # Update with the correct column name
    params = {
        "prompt": f"Based on the following description, what business sector or industry does it suggest? {description}",
        "return_prompt": "Return the business sector / industry based on the description provided.",
